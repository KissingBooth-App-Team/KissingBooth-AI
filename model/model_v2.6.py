...
##############################################################################
# 3. Supervised Contrastive Loss 함수 (NaN 방지 포함)
##############################################################################
@tf.function
...
embedding_model.save("embedding_model_v2.6.h5")
print("Embedding model saved to embedding_model_v2.6.h5")
...
np.save("embedding_model_embedding_v2.6.npy", all_embeddings)
np.save("embedding_model_image_path_v2.6.npy", np.array(normal_paths + outlier_paths))
