...
IMG_HEIGHT = 224
IMG_WIDTH = 224
BATCH_SIZE = 64     # GPU 상황에 맞춰 조절
EPOCHS = 10         # 예시로 10 epoch (적절히 조정)
...
embedding_model.save("embedding_model_v0.11.h5")
print("Embedding model saved to embedding_model_v0.11.h5")
...
# 임베딩 및 이미지 경로 저장
np.save("embedding_model_embedding_v0.11.npy", all_embeddings)
np.save("embedding_model_image_path_v0.11.npy", np.array(all_image_paths))
