...
IMG_HEIGHT = 224
IMG_WIDTH = 224
BATCH_SIZE = 300         # 전체 배치 크기 (정상/이상치 각각 반씩 할당)
EPOCHS = 5         
TEMPERATURE = 0.03      # Supervised Contrastive Loss의 온도 매개변수  
LEARNING_RATE = 1e-4
...
embedding_model.save("embedding_model_v2.3.h5")
print("Embedding model saved to embedding_model_v2.3.h5")
...
np.save("embedding_model_embedding_v2.3.npy", all_embeddings)
np.save("embedding_model_image_path_v2.3.npy", np.array(normal_paths + outlier_paths))
