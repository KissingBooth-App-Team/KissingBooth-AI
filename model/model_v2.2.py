...
##############################################################################
# 3. Supervised Contrastive Loss 함수 (NaN 방지 적용)
##############################################################################
@tf.function
...
embedding_model.save("embedding_model_v2.2.h5")
print("Embedding model saved to embedding_model_v2.2.h5")
...
np.save("embedding_model_embedding_v2.2.npy", all_embeddings)
np.save("embedding_model_image_path_v2.2.npy", np.array(all_image_paths))
